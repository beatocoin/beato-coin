...
import CryptoSettingsForm from "@app/components/CryptoSettingsForm"
...
export default function CryptoOptionsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-[800px]">
      <h1 className="text-3xl font-bold mb-6">Crypto Options</h1>
      <p className="text-gray-600 mb-8">Configure cryptocurrency settings for your application.</p>
